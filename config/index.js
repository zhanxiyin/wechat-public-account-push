export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx94c2272259260181",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "0872c7c135ca119d8b3f1faac7ba0141",
  ...
  USERS: [
    {
      ...
      id: "oFoU-5hydTk22B-mwhb3D5faJATA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "0IBrp296stFlx3qypCiHJOLUGLtD7DLn9S38s0vTcZk",
      // 所在省份
      province: "江西",
      // 所在城市
      city: "上饶",
